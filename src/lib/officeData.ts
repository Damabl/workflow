...
export const officesData: OfficeDetails[] = [
  ...
  },
  {
    ...
    images: [
      { src: "/Teniz Towers/1.jpg", alt: "Teniz Towers офис - вид 1" },
      { src: "/Teniz Towers/2.jpg", alt: "Teniz Towers офис - вид 2" },
      { src: "/Teniz Towers/3.jpg", alt: "Teniz Towers офис - вид 3" },
      { src: "/Teniz Towers/4.jpg", alt: "Teniz Towers офис - вид 4" },
      { src: "/Teniz Towers/5.jpg", alt: "Teniz Towers офис - вид 5" },
    ],
    location: "Алматы",
